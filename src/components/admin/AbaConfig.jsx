    ...
    const salvarConfiguracoes = async (e) => {
        ...
        try {
            ...
            const payload = {
                ...
                percSinal:
                    parseFloat(config.percSinal) >= 0
                        ? parseFloat(config.percSinal)
                        : 50,
        ...
        <div className="max-w-4xl animate-in fade-in duration-300 pb-20">
            ...
            <div className="flex gap-2 border-b border-slate-200 mb-8 pb-px overflow-x-auto no-scrollbar">
                ...
                <button
                    ...
                    className={`px-6 py-3 font-bold text-sm border-b-2 transition-colors whitespace-nowrap ${abaAtual === "fiscal" ? "border-slate-900 text-slate-900" : "border-transparent text-slate-500 hover:text-slate-800"}`}
                >
            ...
            {["geral", "recebimento", "markup", "fiscal"].includes(
                abaAtual,
            ) && (
                <form onSubmit={salvarConfiguracoes} className="space-y-8">
                    ...
                    {abaAtual === "geral" && (
                        <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 animate-in fade-in">
                            <h2 className="text-xl font-black text-slate-800 mb-6 flex items-center gap-2">
                                <Store className="text-slate-400" /> Dados
                                Básicos da Loja
                            </h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="md:col-span-2">
                                    <label className="block text-sm font-bold text-slate-600 mb-1">
                                        Endereço Completo da Loja (Para
                                        clientes)
                                    </label>
                                    <input
                                        type="text"
                    ...
                    {abaAtual === "recebimento" && (
                        <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 animate-in fade-in">
                            <h2 className="text-xl font-black text-slate-800 mb-6 flex items-center gap-2">
                                <DollarSign className="text-slate-400" /> Dados
                                de Recebimento (Pix)
                            </h2>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                ...
                                <div className="md:col-span-2 mt-4 pt-4 border-t border-slate-100">
                                    ...
                                    <p className="text-[10px] text-slate-500 mt-2 leading-relaxed max-w-sm">
                                        Se preencher com <strong>0</strong>, o
                                        sistema irá pular a tela do código Pix e
                                        o pedido irá direto para a sua tela de
                    ...
                    {abaAtual === "markup" && (
                        <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 animate-in fade-in">
                            ...
                            <p className="text-sm text-slate-500 mb-8 max-w-2xl">
                                Insira os percentuais do seu negócio. O sistema
                                utilizará estes dados para gerar um{" "}
                                <strong>Preço Sugerido</strong> automático no
                                Cardápio.
                            </p>
                    ...
                    {abaAtual === "fiscal" && (
                        <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 animate-in fade-in">
                            <h2 className="text-xl font-black text-slate-800 mb-2 flex items-center gap-2">
                                <Receipt className="text-blue-500" /> Dados
                                Fiscais da Empresa
                            </h2>
                            <p className="text-sm text-slate-500 mb-6">
                                Preencha os dados oficiais da sua empresa. Estas
                                informações serão enviadas no cabeçalho das
                            ...
                            {!isModuloFiscalAtivo && (
                                <div className="bg-amber-50 text-amber-700 p-4 rounded-xl mb-6 flex items-start gap-3 border border-amber-200">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-sm">
                                            Os seus dados fiscais podem ser
                                            salvos aqui, mas a emissão
                                            automática de notas fiscais nas
                                            telas de Caixa e Cozinha requer a
                                            liberação deste módulo. Entre em
                                            contato com o suporte para habilitar
                                            os tokens da Sefaz.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                                ...
                                <div>
                                    ...
                                    {/* Utilizando o mesmo campo de cidade já existente na aba geral */}
                                    <input
                                        type="text"
                                        name="cidade"
                                        value={config.cidade || ""}
            ...
            {/* ABA DE EQUIPE (Isolada porque usa Lógica Diferente) */}
            {abaAtual === "equipe" && (
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 animate-in fade-in">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                        <div>
                            <h2 className="text-xl font-black text-slate-800 flex items-center gap-2">
                                <Users className="text-blue-500" /> Equipe e
                                Acessos
                            </h2>
                            <p className="text-sm text-slate-500 mt-1">
                                Gerencie os acessos de Administradores, Garçons
                                e Cozinha.
                            </p>
                        </div>
                    </div>
