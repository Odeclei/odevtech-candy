...
//   // ==========================================
//   // 🔒 SEGURANÇA: Só renderiza se tiver nome da loja
//   // ==========================================
//   if (!nomeDaLoja) {
//     return (
...
//   // ==========================================
//   useEffect(() => {
//     // A verificação já está no início do componente, mas mantemos por segurança
...
//   // ... (as demais funções permanecem iguais: abrirReceita, atualizarStatus, abrirModalEmissao, confirmarEmissaoNf, imprimirNFCe, deveAparecerNaCozinhaHoje, renderColuna)

//   // ==========================================
//   // MODAL DE EMISSÃO
//   // ==========================================
//   const abrirModalEmissao = (pedido) => {
//     // Buscar cliente no cadastro (se existir)
//     const cliente = clientesCadastrados?.find(
//       (c) => c.documento === pedido.cpf || c.nome === pedido.cliente,
//     );

//     // Armazenar o pedido alvo
//     setPedidoNfAlvo(pedido);

//     // Preencher o formulário com os dados do pedido e do cliente
//     setFormNf({
//       tipoNota: "NFCe",
//       cpf: pedido.cpf || "",
//       nome: pedido.cliente || "",
...
//     // ✅ INICIALIZAR ITENS EDITADOS (para NF-e)
...
//         // ✅ CORREÇÃO: passar apenas 3 argumentos (o quarto é ignorado)
...
//       // ✅ Usar os itens editados no payload
//       const mapaItens = {};
//       itensEditados.forEach((item) => {
//         mapaItens[item.codigo_produto] = item;
//       });
...
//       // Criar um clone do pedido com os itens atualizados
//       const pedidoModificado = {
//         ...pedidoNfAlvo,
//         itens: itensParaPayload,
//       };

//       // ✅ Passar mensagem complementar (4º argumento)
...
//           <div className="bg-white rounded-3xl w-full max-w-5xl max-h-[95vh] overflow-y-auto p-6 shadow-2xl">
//             <div className="flex justify-between items-center mb-6">
//               <h2 className="text-xl font-black text-slate-800 flex items-center gap-2">
...
//                 {/* Coluna direita: Tributação dos Itens (apenas para NFe) */}
//                 {formNf.tipoNota === "NFe" && (
//                   <div className="lg:col-span-1">
//                     <div className="border border-slate-200 rounded-xl p-4 bg-slate-50 sticky top-4 max-h-[400px] overflow-y-auto">
