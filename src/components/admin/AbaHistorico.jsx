    ...
    const emitirNFCeDoPedido = async (pedido) => {
        ...
        try {
            ...
            if (!result || !result.sucesso) {
                ...
                alert(
                    "Erro na emissão: " + (result?.mensagem || "Sem detalhes"),
                );
                return;
            }
    ...
    const cancelarNFCeDoPedido = async (pedido) => {
        ...
        try {
            ...
            if (result.sucesso) {
                ...
                throw new Error(
                    result.dadosFocus?.mensagem || "Erro no cancelamento",
                );
            }
        } catch (error) {
