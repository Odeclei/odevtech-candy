...
import imageCompression from "browser-image-compression"; // IMPORTAÇÃO RESTAURADA
  ...
  const salvarProduto = async (e) => {
    ...
    try {
      ...
      if (editandoProdutoId) {
        await updateDoc(doc(db, "produtos", editandoProdutoId), dadosProduto);
        ...
        <form onSubmit={salvarProduto} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              maxLength="8"
              value={novoNcm}
              onChange={(e) => setNovoNcm(e.target.value.replace(/\D/g, ""))}
        ...
        {produtosFiltrados.length === 0 ? (
          ...
          produtosFiltrados
            ...
            .map((p) => {
              ...
              const margem =
                p.preco > 0 ? ((lucroBruto / p.preco) * 100).toFixed(1) : 0;
                    ...
                    <div className="flex-1 w-full">
                      <div className="flex justify-between mb-1">
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            onClick={() =>
                              alternarStatus(p.id, p.ativo !== false)
                            }
