...
export default function AbaCaixaBar({ nomeDaLoja }) {
    ...
    const [comandaNfAlvo, setComandaNfAlvo] = useState(null);
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    {/* BOTÃO DE EMISSÃO FISCAL NO CAIXA */}
                                    {configLoja?.modulos?.includes(
                                        "fiscal",
                                    ) && (
                                        <button
                                            onClick={() =>
                                                abrirModalEmissaoBar(comanda)
                                            }
                                            disabled={comanda.nfEmitida}
            ...
            {modalNfOpen && comandaNfAlvo && (
                <div className="fixed inset-0 bg-slate-900/60 z-50 flex items-center justify-center p-4 backdrop-blur-sm animate-in fade-in">
                    <div className="bg-white rounded-3xl w-full max-w-md p-6 shadow-2xl">
                        ...
                        <form
                            onSubmit={confirmarEmissaoNfBar}
                            className="space-y-4"
                        >
