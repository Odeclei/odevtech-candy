...
// ✅ CORREÇÃO: Caminho absoluto para a pasta refatorada
const AbaKanban = lazy(() => import("../components/admin/AbaKanban/index.jsx"));
...
// ✅ ALINHADO COM O NOME DO ARQUIVO (AbaConfig.jsx)
...
const AbaEventos = lazy(() => import("../components/admin/AbaEventos"));
...
export default function PainelAdmin() {
            ...
            if (!isInitialPedidos) {
                snap.docChanges().forEach((change) => {
                    if (change.type === "added") {
                        ...
                        const valorFormatado = formatarDinheiro(
                            data.valorTotal,
                        );
                        if (
                            data.origem === "mesa" ||
    ...
    // ==========================================
    // 4. RENDERIZAÇÃO DO MENU (COM NOVAS ABAS DE EVENTOS)
    // ==========================================
    const renderizarMenu = () => {
        ...
        if (cargoUsuario === "admin") {
            ...
            // ==========================================
            // ✅ NOVAS ABAS: MÓDULO EVENTOS
            // ==========================================
            // if (true) {
            if (modulosAtivos.includes("eventos")) {
                itensComuns.push(
                    {
                        id: "eventos",
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex overflow-hidden">
            ...
            <main className="flex-1 h-screen overflow-y-auto relative flex flex-col">
                ...
                <div
                    className={`p-6 max-w-7xl mx-auto w-full ${cargoUsuario === "garcom" ? "lg:p-6" : "lg:p-6"} flex-1`}
                >
                    {abaAtiva !== "garcom" && (
                        <div className="mb-10">
                            <h1 className="text-2xl lg:text-3xl font-bold text-slate-800">
                                ...
                                {abaAtiva === "eventos" && "Eventos Especiais"}
                                {abaAtiva === "pdv-tickets" &&
                                    "PDV - Venda de Tickets"}
                                {abaAtiva === "leitor-tickets" &&
                    ...
                    >
                        ...
                        {abaAtiva === "eventos" && (
                            <AbaEventos nomeDaLoja={nomeDaLoja} />
                        )}
                        {abaAtiva === "pdv-tickets" && (
                            <AbaPDVTickets nomeDaLoja={nomeDaLoja} />
                        )}
                        {abaAtiva === "leitor-tickets" && (
                            <AbaLeitorTickets
                                nomeDaLoja={nomeDaLoja}
